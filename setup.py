...
extension = Extension("ntwork.wc.wcprobe",
                      cpp_code_sources,
...
setup(
    ...
    url='https://github.com/smallevilbeast/ntwork',
    author='evilbeast',
    ...
    packages=find_packages(include=['ntwork', 'ntwork.*']),
    keywords='wework ntwork pywework rebot',
